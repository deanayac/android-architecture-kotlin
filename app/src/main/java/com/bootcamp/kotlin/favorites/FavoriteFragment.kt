...
class FavoriteFragment : Fragment(),FavoriteContract.View {
    ...
    private val presenter by lazy { FavoritePresenter(this,Singletons.providerFavoriteRepository()) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter.initContract(this)
        presenter.getFavoriteMovies(FavoriteMoviesRequest(1,"d9ae4921794c06bd0fdbd1463d274804","878539e32c923af4c422e5c0b1fa015ba4aa2dfe"))
        binding.contentMyfavoritesRecyclerView.adapter = adapter
    }
...
//        adapter.moviesList = if(request?.results!=null) request.results else emptyList()
    }
}
