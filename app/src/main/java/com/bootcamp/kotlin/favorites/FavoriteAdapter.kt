...
import kotlinx.android.synthetic.main.item_my_favorites.view.*
...
class FavoriteAdapter() : RecyclerView.Adapter<FavoriteAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_my_favorites, parent, false)
